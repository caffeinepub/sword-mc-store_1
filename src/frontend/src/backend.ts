...
export class Backend implements backendInterface {
    ...
    async adminDeleteOrder(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminDeleteOrder(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetOrderCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetOrderCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetSiteConfig(): Promise<SiteConfig> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetSiteConfig();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminGetUsers(): Promise<Array<[Principal, UserProfile]>> {
        if (this.processError) {
            try {
    ...
    async adminUpdateOrderStatus(arg0: bigint, arg1: OrderStatus): Promise<void> {
        if (this.processError) {
            try {
    ...
    async adminUpdateSiteConfig(arg0: SiteConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminUpdateSiteConfig(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPublicSiteConfig(): Promise<SiteConfig> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublicSiteConfig();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOrder(arg0: Order): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOrder(to_candid_Order_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
